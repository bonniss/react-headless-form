...
The docs site publishes LLM-friendly outputs generated by Rspress SSG-MD:

- `llms.txt` for the high-level documentation index
- `llms-full.txt` for a larger single-file Markdown context
- `.md` versions of individual docs pages

Use these files to understand the library's usage and semantics instead of scraping rendered HTML.
