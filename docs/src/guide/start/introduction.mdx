...
For the sake of brevity, throughout the documentation we sometimes refer to the library simply as **`BlueForm`**, a short and convenient alias for `react-headless-form`.
:::
